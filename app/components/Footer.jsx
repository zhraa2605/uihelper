...
export default function Footer() {
    ...
    <footer className="text-gray-950 pt-16 bg-transparent relative overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto p-4 sm:px-6 lg:px-8 z-10 relative flex flex-col items-center">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl sm:text-5xl font-bold py-12 leading-snug">
            Helping you
            <span className="text-purple-400"> build </span>
             and launch <br /> better UI experiences
          </h2>
  ...
  <div className="flex max-w-sm rounded-xl bg-gradient-to-tr from-pink-300 to-blue-300 p-0.5 shadow-lg">
    <button
      onClick={handleCopy}
      className="flex items-center justify-center gap-2 text-md bg-white px-4 py-2 rounded-xl tracking-wider duration-500 "
    >
